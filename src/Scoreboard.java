public class Scoreboard {
    ...
    public String getScore() {
        return team1Points + "-" + team2Points + "-" + activeTeam;
    }
    ...
    public int returnWinnerPoints(){
        if (returnWinner().equals(team1)) return team1Points;
        else if (returnWinner().equals(team2)) return team2Points;
        return 0;
    }
